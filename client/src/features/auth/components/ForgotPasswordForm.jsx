...
function ForgotPasswordForm() {
    const { requestPasswordResetLink, authStatus, authError , authSuccessMessage } = useAuth();
  ...
  return (
      <div className="p-8 bg-white rounded shadow-md w-full max-w-md">
        ...
        {authSuccessMessage && (
          <p className="mt-4 text-green-600 text-center text-sm">{authSuccessMessage}</p>
        )}
      </div>
  )
}
